...
public class TagRiver2 extends WorldGeom
{
  ...
  {
    userLabel1 = GeomTag2.newGeomTextConstrainedByHeight("user1", new Point3f(), 0.12f);

    this.holder.addGeom(userLabel1);
    userLabel1.setPos(-0.3f, 0.1f, 0.0f);
    userLabel1.setColor(0.7f, 0.7f, 0.7f);

    userLabel2 = GeomTag2.newGeomTextConstrainedByHeight("user2", new Point3f(), 0.12f);

    this.holder.addGeom(userLabel2);
    userLabel2.setPos(-0.3f, 1.2f, 0.0f);
    userLabel2.setColor(0.7f, 0.7f, 0.7f);


    userLabel3 = GeomTag2.newGeomTextConstrainedByHeight("user3", new Point3f(), 0.12f);

    this.holder.addGeom(userLabel3);
    userLabel3.setPos(-0.3f, 1.8f, 0.0f);
    userLabel3.setColor(0.7f, 0.7f, 0.7f);

    userLabel4 = GeomTag2.newGeomTextConstrainedByHeight("user4", new Point3f(), 0.12f);
