...
public class Dot extends Point2D.Double
{
  ...
  public static void removeIllegalDots(List<Dot> dots, float flub)
  {
  ...
  public static void removeIllegalDots(List<Dot> xdots, List<Dot> ydots, float flub)
  {
    List<Dot> culledxdots = new ArrayList<Dot>();
    List<Dot> culledydots = new ArrayList<Dot>();
    
    double maxydist = 100.0;
  ...
  /*
  public static void removeIllegalDots(java.util.List<Dot> xdots, java.util.List<Dot> ydots, float flub)
  {
  ...
  public static void sortDotsByClosestToCorner(java.util.List<Dot> dots)
  {
    Collections.sort(dots, new Comparator()
    {
      public int compare(Object a, Object b)
      {
        ...
        float dist1 = (float) Math.sqrt( Math.pow(dot1.xdist, 2) + Math.pow(dot1.ydist, 2) );
        float dist2 = (float) Math.sqrt( Math.pow(dot2.xdist, 2) + Math.pow(dot2.ydist, 2) );
